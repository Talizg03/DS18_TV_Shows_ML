...
•	Hyperparameter tuning with RandomizedSearchCV improved the Random Forest model by by reducing the MAE by 7.40% and the RMSE by 11.51%. Key tuned parameters included n_estimators, max_features, and max_depth.
